                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <table>
                                <tr>
                                    <form method="POST" action="quotationreport_action.php">
...
<script>
var ajax_url = "<?php echo roothtml.'quotationreport/quotationreport_action.php'; ?>";
$(document).ready(function() {
    ...
    $(document).on("click", "#btngo", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                window.location.href = "<?= roothtml.'quotationreport/quotationdetail.php'?>";
            }
        });
    });
