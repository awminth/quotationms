            ...
            $out.="<tr>
                ...
                <td class='text-center'>
                    <div class='btn-group btn-group-sm'>
                        <a href='#' id='btngo' data-toggle='tooltip' data-placement='bottom'
                            title='Go'
                            data-aid='{$row['AID']}'
                            class='btn btn-success btn-sm'><i class='fas fa-paper-plane'></i></a>
                    </div>
                </td>
            </tr>";
        }
...
if($action == "go"){
    $aid = $_POST["aid"];
    $_SESSION["report_createquotationaid"] = $aid;
}
