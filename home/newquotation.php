                ...
                <div class="col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= roothtml.'home/quotation.php'?>" class="btn btn-primary"><i
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control border-success"
                                                            name="codeno" id="codeno" placeholder="CodeNo">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control border-success"
                                                            name="qty" id="qty" placeholder="Quatity">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control border-success"
                                                            name="purprice" id="purprice" placeholder="Purchase Price">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control border-success"
                                                            name="selprice" id="selprice" placeholder="Sell Price">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <label for="usr">Category :</label>
                                                        <select class="form-control border-success" name="category"
                                                            id="category">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control border-success" name="supplier"
                                                            id="supplier">
